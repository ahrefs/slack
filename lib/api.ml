...
module type S = sig
  ...
  (* conversations *)
  val get_replies :
    ctx:Context.t -> conversation:conversations_replies_req -> conversations_replies_res slack_response Lwt.t
  val get_conversations_info :
    ctx:Context.t -> conversation:conversations_info_req -> conversations_info_res slack_response Lwt.t
  ...
  val update_usergroup_users :
    ctx:Context.t -> usergroup:update_usergroups_users_req -> update_usergroups_users_res slack_response Lwt.t
  ...
  val list_usergroup_users :
    ctx:Context.t -> usergroup:list_usergroup_users_req -> list_usergroup_users_res slack_response Lwt.t
